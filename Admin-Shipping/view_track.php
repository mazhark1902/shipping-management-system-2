      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Tracking Number</h1>
            <p class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <dl>
                                ...
                                <dd>
                                    <?php echo $row['status']; ?>
                                    <a class="btn badge badge-primary bg-gradient-primary" href="update_status.php?id=<?php echo $row['tracking_id']; ?>">
