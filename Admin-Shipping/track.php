      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Table Data Of Tracking</h1>
            <p class="mb-4">
            ...
            while ($row = $result_select_tracking->fetch_assoc()) :
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <a class="dropdown-item view_tracking" href="view_track.php?id=<?php echo $row['tracking_id']; ?>">
    <i class="fas fa-eye"></i> View
</a>
                            <a class="dropdown-item delete_tracking"   data-id="<?php echo $row['tracking_id']; ?>">
