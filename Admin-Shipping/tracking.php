      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Tracking The Vehicle</h1>
            <p class="mb-4"></p>
            <?php 
            ...
            <div id="clone_timeline-item" class="d-none">
              <div class="iitem">
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">asdasd</div>
                </div>
              </div>
            </div>
            <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script>
        function start_load() {
            // Placeholder for start_load function
            console.log("Loading started...");
        }

        function end_load() {
            // Placeholder for end_load function
